...
import { borderColor, colorHr, fsCard, fsCardTitle, priceColor, textColor } from "../../style.golbal";
  ...
  return (
    <Box display={"flex"} justifyContent={"center"} gap={2} >
      ...
      >
        ...
        <HStack justify={"center"} textAlign={"center"} flexDirection={"column"}>
          ...
          <Box display={"flex"} justifyContent={"center"} alignItems={"center"}>
            ...
            <Text fontWeight={"semibold"} fontSize={fsCardTitle} marginLeft={"2px"} color={priceColor}>
